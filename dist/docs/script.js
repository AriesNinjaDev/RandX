...
code('bt1',`myVar: 5 // sets myVar to 5
...
code('bt3',`[myList] // returns a random item from myList
...
code('sv1',`_amount: 3 // sets the amount of results produced to 3
...
code('rt1',`[a-z] // returns a random letter between a and z
[A-Z] // returns a random letter between A and Z
...
code('rt2', `[PLURAL:myVar] // returns s if myVar is not 1
...
code('rt3', `// In myList, apple has a 20% chance of being selected, and banana has a 30% chance of being selected. The rest are equally likely, meaning cherry and orange each have a 25% chance of being selected.
list myList:
- apple 20%
- banana 30%
- cherry
